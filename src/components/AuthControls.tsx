 ...
 * If the user is signed in, it displays a Profile link and Sign Out button.
 *
...
export default function AuthControls() {
  ...
  // If a valid session exists, allow the user to view their profile and sign out
  if (status === "authenticated") {
    return (
      <>
        {/* Give the authenticated user access to their profile dashboard */}
        <Link
          href="/profile"
